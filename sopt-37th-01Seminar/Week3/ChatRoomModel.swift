...
struct ChatRoomModel {
    ...
    static let mockData: [ChatRoomModel] = [
        ChatRoomModel(profileImage: UIImage(named: "profile"), name: "이명진", location: "대한민국", lastMessage: "확인했습니다 감사합니다 :)", thumbnail: UIImage(named: "item1")),
        ...
        ChatRoomModel(profileImage: UIImage(named: "profile"), name: "김나연", location: "영국", lastMessage: "김나연님이 이모티콘을 보냈어요.", thumbnail: UIImage(named: "item6")),
        ChatRoomModel(profileImage: UIImage(named: "profile5"), name: "이서현", location: "독일", lastMessage: "이서현님이 이모티콘을 보냈어요.", thumbnail: UIImage(named: "item7")),
        ...
        ChatRoomModel(profileImage: UIImage(named: "profile4"), name: "진소은", location: "캐나다", lastMessage: "감사합니다! 조심하가세요~!", thumbnail: UIImage(named: "item"))
    ]
